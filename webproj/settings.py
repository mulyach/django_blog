...
#SECRET_KEY = '9brbkpm%$(pyu$uebof04!h=960bflss%5)&%2bx&)nxy5qp_-'
...
#STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'   #disable this when running using daphne asgi
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [os.environ.get('REDIS_URL', 'redis://localhost:6379')], #"hosts": [(os.environ.get('REDIS_URL', '127.0.0.1'),6379)],
        },
    },
}